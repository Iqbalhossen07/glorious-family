...
export default function AddBazarPage() {
  ...
  return (
    <div style={{ animation: 'fadeIn 0.5s ease', paddingBottom: '5rem', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '0.2rem' }}>Add Bazar</h1>
          <p style={{ color: 'var(--text-muted)' }}>Record a new expense</p>
        </div>
      </div>
