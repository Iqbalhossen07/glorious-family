    ...
    <div style={{ background: '#f1f5f9', minHeight: '100vh', padding: '1rem' }} className="invoice-container">
      ...
      <div className="hide-on-print" style={{ maxWidth: '800px', margin: '0 auto 1rem', display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          <button onClick={() => router.push(`/dashboard/members/${userId}`)} className="btn" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: '#fff', border: '1px solid var(--primary)', color: 'var(--primary)', padding: '0.5rem 1rem', borderRadius: '8px', cursor: 'pointer', fontWeight: 600 }}>
